...
public class ShortcutPrefixActiveEvent extends ChangeEvent
{
	...
	{
		//Log.org.log( Log.DEBUG, ShortcutPrefixActiveEvent.class, "firePrefixStateChange() called, listening? " + listeningForShortcutCompletion );
		// Guaranteed to return a non-null array
		Object[] listeners = listenerList.getListenerList();
		//Log.org.log( Log.DEBUG, ShortcutPrefixActiveEvent.class, listeners.length + " listeners." );
