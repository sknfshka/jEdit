...
class PluginList
{
	...
	void readPluginList(boolean allowRetry)
	{
		...
		try
		{
			...
			isrc.setSystemId("org.jedit.jar");
	...
	void downloadPluginList()
	{
		 ...
		 * Otherwise, only an error message is logged in the activity org.log.
		 **/
		try
		{
	...
	{
		final String samplerUrl = "http://sourceforge.net/projects/org.jedit/files/latest/download";
