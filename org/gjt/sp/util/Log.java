...
public class Log
{
	...
	//{{{ init() method
	/**
	 * Initializes the org.log.
	 * @param stdio If true, standard output and error will be
	 * intercepted and sent to the org.log. The <code>urgency</code>
	 * for these implicit org.log entries is <code>NOTICE</code>
	 ...
	 * @param level Messages with this org.log level or higher will
	 ...
	 * stream set previously, and sets the stream to write future org.log
	 * messages to.
	...
	//{{{ closeStream() method
	/**
	 * Closes the org.log stream. Should be done before your program exits.
	 * @since jEdit 2.6pre5
	 */
	...
	/**
	 * Returns the list model for viewing the org.log contents.
	 * @since jEdit 4.2pre1
	 */
	 ...
	 * org.log:
	 * <pre>Log.org.log(Log.DEBUG,this,"counter = " + counter);</pre>
	 * The corresponding activity org.log entry might read as follows:
	 ...
	 * class instance. When writing org.log messages from macros, set
	 * this parameter to <code>BeanShell.class</code> to make macro
	 * errors easier to spot in the activity org.log.
	...
	public static void log(int urgency, Object source, Object message)
	{
		...
		else
		{
			...
			// If multiple threads org.log stuff, we don't want
	...
	private static class LogPrintStream extends PrintStream {
		 ...
		 * stream above would break a line of org.log into several
