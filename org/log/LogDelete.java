...
public class LogDelete extends LogKey {
	...
	public LogDelete(final int keyCode, final int position, final int mask) {
		super(position, mask, keyCode);
		this.type = LogEventTypes.DELETE_KEY;
	}

	public LogDelete(final int keyCode, final int position, final int mask, final String text, int deletedCharPosition) {
		super(position, mask, keyCode);
		this.type = LogEventTypes.DELETE_KEY;
	...
	public String getStringForm() {
		return String.format("Delete key with key code %d. %d. Deleted text %s in position %d", keyCode, timestamp, deletedText, deletedCharPosition);
	}
